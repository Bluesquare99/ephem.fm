...
var _iconViewJs = require("./views/iconView.js");
var _iconViewJsDefault = parcelHelpers.interopDefault(_iconViewJs);
...
const controlAudio = function(station) {
    ...
    const audio = new Audio(`${_modelJs.stations[station].streamingUrl}`);
    audio.play();
};
const init = function() {
    _audioViewJsDefault.default.addHandlerStation(controlAudio);
    _iconViewJsDefault.default.addHandlerTable(toggleHidden);
};
init();

},{"./model.js":"Y4A21","./config.js":"k5Hzs","./views/weatherView.js":"jcuJR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/audioView.js":"2HQ1H","./views/iconView.js":"guA36"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_WEATHER_URL", ()=>API_WEATHER_URL
);
...
class audioView extends _viewJsDefault.default {
    ...
    addHandlerStation(handler) {
        this._parentEl.addEventListener("click", function(e) {
            ...
            console.log(_chromaJsDefault.default("#c2fa00").darken().saturate().hex());
            if (!tableRow) return;
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chroma-js":"iVrwS"}],"iVrwS":[function(require,module,exports) {
...
},{}],"guA36":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class iconView extends _viewJsDefault.default {
